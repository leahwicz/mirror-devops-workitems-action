...
async function getWorkItems(azpPAT, azpOrg, areaPath, workItemType) {
    ...
    const wiql = `SELECT [System.Id], [System.WorkItemType], [System.Title], [System.State] from workitems where ${filterOnType} [System.AreaPath] UNDER 'AzureDevOps\\VSTS\\Pipelines\\Akvelon Pipelines Task Team' AND [System.State] = '5 - PG Engaged'`;
